...
export default function LoginModal({ show, onClose }) {
  ...
  return (
    <div
      aria-hidden="true"
      className={`fixed hidden inset-0 bg-black bg-opacity-50 md:flex justify-center items-center opacity-0 transition-all duration-300 ease-out pointer-events-none ${
