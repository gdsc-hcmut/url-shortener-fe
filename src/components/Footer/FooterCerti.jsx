...
export default function FooterCerti() {
  return (
    <div className="bg-gdscGrey-700 h-[178px] md:min-h-fit w-full xl:pl-[300px] xl:pr-[300px] lg:pl-[240px] lg:pr-[240px] md:pl-[160px] md:pr-[160px] md:py-[28px] px-[5.625vw] pt-[40px] pb-[32px]">
